            ...
            >
              <div className="workspace-heading">
                <button
                  ...
                  aria-haspopup={disableRecentDrawer ? undefined : "dialog"}
                  aria-label={sidebarToggleLabel}
                  className="titlebar-icon-button sidebar-toggle-button"
                  disabled={disableRecentDrawer}
                  onClick={(event) => {
